...
//		        .writer(flatFileItemWriter)
	...
	public FlatFileItemReader<XiaoShuo> flatFileItemReader() {
		...
		delimitedLineTokenizer.setNames(new String[] { "nameString", "autherString", "msgString", "instroString", "urlString", "picString" });
		//
